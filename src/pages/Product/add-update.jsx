...
export default class ProductAddUpdate extends Component {
    ...
    submit = () => { // validate the form
        ...
        }).catch(error => message.error("please complete the table"))
    }
    ...
    initOptions = async (categories) => {
        ...
        */
        ...
        if (isUpdate && pCategoryId != 0) {
            ...
            const categorywithsubId = options.findIndex(item => item.value === pCategoryId)
            options[categorywithsubId]['children'] = this.addOptions(subcategories)
        }
        ...
        return (
            <Card title={title}>
                <Form ref={
                    ...
                    <Item name="productDetail" label="Product detail"
                        initialValue={
                            product.desc
                        }
                        rules={
                            ...
                            [
                                {
                                ...
                                }, ({getFieldValue}) => (
                                    {
                                        validator(_, value) {
                                            ...
                                            return Promise.reject(new Error('The price must be bigger than 0!'));
                                        }
                                    }
                                ),
                            ]
                    ...
                    <Item name="images" label="Images">
                        <PicturesWall bindPictures={
                                x => this.getUploadedPicture = x
                            }
                            imgs={imgs}/>
                    </Item>
                    <Item labelCol={
                        ...
                        name="description"
                        label="Description"><RichTextEditor detail={detail}
                            bindDtails={
                                x => this.getDetails = x
                            }/></Item>
